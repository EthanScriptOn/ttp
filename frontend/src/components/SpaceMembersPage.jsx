...
export default function SpaceMembersPage({ role, user }) {
  ...
  const load = async () => {
    setLoading(true)
    setError('')
    const results = await Promise.allSettled([getSpaceMembers(), getSpacePermissions()])
    const [membersResult, permissionsResult] = results
    const failures = []
  ...
  return (
    <div className="page-wrap space-members-page space-settings-page">
        ...
        <div className="space-settings-grid">
          <section className="space-settings-section space-settings-members">
            <div className="space-settings-section-head">
              <div><Typography.Title level={4}><TeamOutlined /> 空间成员</Typography.Title></div>
          ...
          <section className="space-settings-section space-settings-roles">
            <div className="space-settings-section-head">
              <div><Typography.Title level={4}><SafetyCertificateOutlined /> 角色权限</Typography.Title></div>
            </div>
