export const PERMISSIONS = Object.freeze({
  ...
  PROJECT_GIT_READ: 'project:git:read',
  PROJECT_GIT_MANAGE: 'project:git:manage',
  PROJECT_DEPLOYMENT_READ: 'project:deployment:read',
  PROJECT_DEPLOYMENT_MANAGE: 'project:deployment:manage',
  PROJECT_RELEASE_READ: 'project:release:read',
  PROJECT_RELEASE_CREATE: 'project:release:create',
  PROJECT_RELEASE_UPDATE: 'project:release:update',
  PROJECT_RELEASE_PUBLISH: 'project:release:publish',
  PROJECT_RUNTIME_READ: 'project:runtime:read',
  PROJECT_RUNTIME_CONFIG: 'project:runtime:config',
  PROJECT_RUNTIME_TERMINAL: 'project:runtime:terminal',
