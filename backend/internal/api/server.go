...
func (s *Server) routes() {
	...
	protected.POST("/clusters/:clusterID/image-registry-connections/:connectionID/pull-test", requirePermission(s.deps.Store, permissions.ClusterManage), requirePermission(s.deps.Store, permissions.RegistryManage), s.testRegistryPull)
	...
	protected.POST("/projects/:projectID/deployment-resource-overrides", requireProjectPermission(s.deps.Store, permissions.ProjectDeploymentManage), s.createDeploymentResourceOverride)
	protected.PUT("/projects/:projectID/deployment-resource-overrides/:overrideID", requireProjectPermission(s.deps.Store, permissions.ProjectDeploymentManage), s.updateDeploymentResourceOverride)
	protected.DELETE("/projects/:projectID/deployment-resource-overrides/:overrideID", requireProjectPermission(s.deps.Store, permissions.ProjectDeploymentManage), s.deleteDeploymentResourceOverride)
	...
	protected.GET("/projects/:projectID/release-flow", requireProjectPermission(s.deps.Store, permissions.ProjectReleaseRead), s.getReleaseFlow)
	...
	protected.PATCH("/projects/:projectID/releases/:releaseID/targets/:targetID/traffic", requireProjectPermission(s.deps.Store, permissions.ProjectReleasePublish), s.updateReleaseTraffic)
	...
	protected.POST("/projects/:projectID/releases/:releaseID/republish", requireProjectPermission(s.deps.Store, permissions.ProjectReleasePublish), requireProjectPermission(s.deps.Store, permissions.ProjectReleaseUpdate), s.republishRelease)
	protected.DELETE("/projects/:projectID/releases/:releaseID", requireProjectPermission(s.deps.Store, permissions.ProjectReleaseUpdate), s.removeRelease)
	...
	protected.GET("/projects/:projectID/pods/:podName/terminal", requireProjectPermission(s.deps.Store, permissions.ProjectRuntimeTerminal), s.podTerminal)
